    ...
    public class Заявка : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаявкаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаявкаE", typeof(IIS.Test11.Заявка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаявкаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаявкаL", typeof(IIS.Test11.Заявка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаявкаНаРаботыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаявкаНаРаботыE", typeof(IIS.Test11.Заявка));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаявкаНаРаботыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаявкаНаРаботыL", typeof(IIS.Test11.Заявка));
                }
            }
        }
    }
